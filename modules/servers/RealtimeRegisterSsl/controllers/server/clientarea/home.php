...
class home extends main\mgLibs\process\AbstractController {
    ...
    public function renewJSON($input, $vars = array()) {
        ...
        {
            main\eHelpers\Whmcs::savelogActivityRealtimeRegisterSsl("Realtime Register Ssl WHMC Renew Action Error: " . $e->getMessage());
            return array(
                'error' => $e->getMessage(),
            );
        }
        ...
        {
            main\eHelpers\Whmcs::savelogActivityRealtimeRegisterSsl("Realtime Register Ssl WHMC Renew Action Error: " . $errorInvoiceExist);
