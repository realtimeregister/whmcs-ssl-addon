...
class EmailTemplateService {
    ...
    const CONFIGURATION_TEMPLATE_ID = 'RealtimeRegisterSsl - Configuration Required';
    const EXPIRATION_TEMPLATE_ID = 'RealtimeRegisterSsl - Service Expiration';
    const SEND_CERTIFICATE_TEMPLATE_ID = 'RealtimeRegisterSsl - Send Certificate';
    const RENEWAL_TEMPLATE_ID = 'RealtimeRegisterSsl - Renewal';
    const REISSUE_TEMPLATE_ID = 'RealtimeRegisterSsl - Reissue';
    ...
    public static function createRenewalTemplate() {
        ...
        $newTemplate          = new \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate();
    ...
    public static function updateRenewalTemplate() {        
        $template          =  \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereName(self::RENEWAL_TEMPLATE_ID)->first();
    ...
    public static function updateConfigurationTemplate() {        
        $template          =  \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereName(self::CONFIGURATION_TEMPLATE_ID)->first();
    ...
    public static function getTemplate($name) {
        return \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereName($name)->first();
    }
    
    public static function getTemplateName($id) {
        $template  = \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereId($id)->first();
    ...
    {
        return \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereType('product')->get();
    }    
    ...
    public static function updateReissueTemplate() {        
        $template          =  \MGModule\RealtimeRegisterSsl\eModels\whmcs\EmailTemplate::whereName(self::REISSUE_TEMPLATE_ID)->first();
