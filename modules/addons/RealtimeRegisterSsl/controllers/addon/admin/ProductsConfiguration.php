...
class ProductsConfiguration extends AbstractController
{
    ...
    public function saveProducts($input = array(), $vars = array())
    {
        ...
        if (isset($input['many-products']) && $input['many-products'] == '1') {
            ...
            foreach ($products as $product) {
                ...
                if (isset($input[C::PRODUCT_INCLUDED_SANS_WILDCARD]) && !empty($input[C::PRODUCT_INCLUDED_SANS_WILDCARD])) {
                    $productModel->updateProductParam($product->id, C::PRODUCT_INCLUDED_SANS_WILDCARD, $input[C::PRODUCT_INCLUDED_SANS_WILDCARD]);
                }
    ...
    public function getCreatorJSON()
    {
        ...
        $creator->addField(new TextField(array(
