...
class ProductsCreator extends main\mgLibs\process\AbstractController {
    ...
    public function indexHTML($input = [], $vars = []) {
        try {
            $this->apiProductsRepo = main\eRepository\RealtimeRegisterSsl\Products::getInstance();
    ...
    public function saveProduct($input = array()) {
        ...
        $productData = [
            ...
            'servertype' => 'RealtimeRegisterSsl',
            'hidden'     => '1',
    ...
    public function saveProducts($currencies, $post) {
        ...
        $productModel = new \MGModule\RealtimeRegisterSsl\models\productConfiguration\Repository();
        $moduleProducts = $productModel->getModuleProducts('RealtimeRegisterSsl', $post['gid']);
