...
class ApiConfiguration extends main\mgLibs\process\AbstractController
{
    ...
    public function indexHTML($input = [], $vars = [])
    {
        ...
        $field->continue          = false;
        $field->enableDescription = true;
        $field->options           = \MGModule\RealtimeRegisterSsl\eRepository\whmcs\config\Countries::getInstance()->getCountriesForMgAddonDropdown();
        ...
        $field->name              = 'send_certificate_template';
        $field->required          = true;
        $field->value             = ($input['send_certificate_template'] == NULL) ? \MGModule\RealtimeRegisterSsl\eServices\EmailTemplateService::getTemplate('Realtime Register Ssl - Send Certificate')->id : $input['send_certificate_template'];
        $field->translateOptions  = false;
        $field->inline            = true;
        $field->colWidth          = 4;
        $field->continue          = false;
        $field->enableDescription = true;
        $field->options           = $this->prepareGeneralEmailTemplatedArray(\MGModule\RealtimeRegisterSsl\eServices\EmailTemplateService::getGeneralTemplates());
        ...
        $vars['cronCommandLine']  = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'cron.php';
        $vars['cronCommandLine7']  = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'APIProcessingOrders.php';
        $vars['cronCommandLine8'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'APIDailyStatusUpdater.php';
        $vars['cronCommandLine2'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'certificateStatsLoader.php';
        $vars['cronCommandLine3'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'notifier.php';
        $vars['cronCommandLine4'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'certificateSender.php';
        $vars['cronCommandLine5'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'APIPriceUpdater.php';
        $vars['cronCommandLine6'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'certificateDetailsUpdater.php';
        $vars['cronCommandLine9'] = 'php -q ' . ROOTDIR . DS . 'modules' . DS . 'addons' . DS . 'RealtimeRegisterSsl' . DS . 'cron' . DS . 'installCertificates.php';
