...
use MGModule\RealtimeRegisterSsl\models\whmcs\service\Repository as ServiceRepo;
...
class Configuration extends AbstractConfiguration
{
     ...
     * @var string
     */
    public $systemName = 'RealtimeRegisterSsl';
    ...
    function upgrade($vars)
    {
        ...
        if (version_compare($version, '1.0.32', '<='))
        {
            ...
            LogsHelper::savelogActivityRealtimeRegisterSsl('Realtime Register Ssl WHMCS Upgrade Start.');
            ...
            if (!empty($serviceIDs))
            {
                LogsHelper::savelogActivityRealtimeRegisterSsl('SSL certificates associated with services with identifiers: ' . implode(', ', $serviceIDs) . ' have been marked as sent.');
            }

            LogsHelper::savelogActivityRealtimeRegisterSsl('Realtime Register Ssl WHMCS Upgrade Completed.');
        }
    }
}
