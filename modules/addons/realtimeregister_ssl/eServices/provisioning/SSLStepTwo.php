...
class SSLStepTwo
{
    ...
    const PRODUCTS_WITH_ADDITIONAL_SAN_VALIDATION = [139, 100, 99, 63, 25, 24];
    ...
    private function validateSansDomains()
    {
        ...
        $invalidDomains = \MGModule\RealtimeRegisterSsl\eHelpers\Domains::getInvalidDomains($sansDomains);
