...
class ZipFileHelperTest extends TestCase
{
    ...
    {
        $zipFileHelper = new \AddonModule\RealtimeRegisterSsl\eHelpers\ZipFileHelper(file_get_contents(__DIR__ . '/../data/zero-bytes-file.zip'));
    ...
    {
        $zipFileHelper = new \AddonModule\RealtimeRegisterSsl\eHelpers\ZipFileHelper(file_get_contents(__DIR__ . '/../data/one-file.zip'));
    ...
    {
        $zipFileHelper = new \AddonModule\RealtimeRegisterSsl\eHelpers\ZipFileHelper(file_get_contents(__DIR__ . '/../data/file-in-directory.zip'));
