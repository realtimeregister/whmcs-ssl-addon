...
class Repository extends \MGModule\RealtimeRegisterSsl\mgLibs\models\Repository
{
    ...
    {
        $this->_filters[] = " ( monthly > 0.00 OR quarterly > 0.00 OR semiannually > 0.00 OR annually > 0.00 " .
            "OR  biennially > 0.00  OR triennially > 0.00 )";
    }

    public function withDomainCycle()
    {
        $this->_filters[] = " ( msetupfee > 0.00 OR qsetupfee  > 0.00 OR ssetupfee  > 0.00 OR asetupfee  > 0.00 " .
            "OR  bsetupfee > 0.00  OR tsetupfee > 0.00 OR monthly > 0.00 OR quarterly > 0.00 OR semiannually > 0.00 " .
            "OR annually > 0.00 OR  biennially > 0.00  OR triennially > 0.00 )";
    }
}
